...
mindhorn = media.Movie(
		'Mindhorn',
		'Former television actor finds himself by understanding that selfhood is a fiction',
...
psychoRaman = media.Movie('Pyscho Raman',
		'This might be a question on the state monopoly on violence, or just some Jungian shadow-self craziness',
...
wizardpeople = media.Movie('Wizard People, Dear Reader',
		'It\'s arguable whether or not this is actually a movie. A re-telling of some other movie maybe you\'ve seen before',
